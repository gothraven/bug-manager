...
function ProfileView() {
  ...
  return (
    <Grid container direction="column" alignContent="center">
      <Grid item xs={9} container direction="column" alignItems="center" spacing={4}>
        <Grid item>
          <UserAvatar user={me} className={classes.userIcon} />
        </Grid>
        <Grid item xs={9} container direction="column" alignItems="center" spacing={1}>
        ...
        <Grid item container direction="column" justify="center" alignItems="center">
          ...
          <Grid item xs={6}>
            <Typography variant="body1" align="center">
              We do not have enough data to show this stage.
              soon here you will see statistics about your contributions in fixing issues.
          </Typography>
          </Grid>
        </Grid>
      </Grid>
